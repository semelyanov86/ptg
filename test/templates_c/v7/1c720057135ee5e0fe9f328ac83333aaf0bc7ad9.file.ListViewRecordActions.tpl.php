<?php /* Smarty version Smarty-3.1.7, created on 2020-06-11 11:50:23
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Documents/ListViewRecordActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14686070075ee1f04fda2698-33534225%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c720057135ee5e0fe9f328ac83333aaf0bc7ad9' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Documents/ListViewRecordActions.tpl',
      1 => 1524058846,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14686070075ee1f04fda2698-33534225',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee1f04fe60af',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee1f04fe60af')) {function content_5ee1f04fe60af($_smarty_tpl) {?>
...
" onclick="Vtiger_Header_Js.previewFile(event)"><?php echo vtranslate('LBL_VIEW_FILE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a></li><?php }?><?php if ($_smarty_tpl->tpl_vars['DOCUMENT_RECORD_MODEL']->value->get('filename')&&$_smarty_tpl->tpl_vars['DOCUMENT_RECORD_MODEL']->value->get('filestatus')&&$_smarty_tpl->tpl_vars['DOCUMENT_RECORD_MODEL']->value->get('filelocationtype')=='I'){?><li><a data-id="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getId();?>
...
</a></li><?php }?></ul></span><div class="btn-group inline-save hide"><button class="button btn-success btn-small save" name="save"><i class="fa fa-check"></i></button><button class="button btn-danger btn-small cancel" name="Cancel"><i class="fa fa-close"></i></button></div></div>
<?php }} ?>