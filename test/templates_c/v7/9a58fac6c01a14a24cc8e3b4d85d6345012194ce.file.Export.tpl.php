<?php /* Smarty version Smarty-3.1.7, created on 2020-06-12 12:06:32
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Vtiger/Export.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6039617325ee34598dab852-31738208%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9a58fac6c01a14a24cc8e3b4d85d6345012194ce' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Vtiger/Export.tpl',
      1 => 1523977545,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6039617325ee34598dab852-31738208',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee34598e15d6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee34598e15d6')) {function content_5ee34598e15d6($_smarty_tpl) {?>
...
&nbsp;</div></div><?php }?></div><br><div><b><?php echo vtranslate('LBL_DELIMITER',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</b></div><br><div style="margin-left: 50px;"><div><?php  $_smarty_tpl->tpl_vars['_DELIMITER_LABEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['_DELIMITER_LABEL']->_loop = false;
...
?>&nbsp;&nbsp;<label style="font-weight:normal" class="radio-group"><input type="radio" name="delimiter" value="<?php echo $_smarty_tpl->tpl_vars['_DELIMITER']->value;?>
...
</label><?php } ?></div></div><br></div></div><div class="col-lg-3"></div></div></div><div class="modal-overlay-footer clearfix"><div class="row clearfix"><div class=" textAlignCenter col-lg-12 col-md-12 col-sm-12 "><div><button type="submit" class="btn btn-success btn-lg"><?php echo vtranslate('LBL_EXPORT','Vtiger');?>
