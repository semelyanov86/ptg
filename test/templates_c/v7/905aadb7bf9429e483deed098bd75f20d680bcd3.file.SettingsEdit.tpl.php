<?php /* Smarty version Smarty-3.1.7, created on 2020-06-10 22:14:36
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/MailManager/SettingsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15152847865ee1311ce276a6-87543317%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '905aadb7bf9429e483deed098bd75f20d680bcd3' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/MailManager/SettingsEdit.tpl',
      1 => 1591234382,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15152847865ee1311ce276a6-87543317',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee1311ce7856',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee1311ce7856')) {function content_5ee1311ce7856($_smarty_tpl) {?>
...
</td></tr><tr class="settings_details <?php if ($_smarty_tpl->tpl_vars['SERVERNAME']->value==''){?>hide<?php }?>"><td class="fieldLabel width40per"><label class="pull-right detailViewButtoncontainer"><?php echo vtranslate('LBL_SET_TRASH',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></td><td class="fieldValue selectTrashValue <?php if (!$_smarty_tpl->tpl_vars['MAILBOX']->value->exists()){?>hide<?php }?>"><select name="_mbox_trash_folder" class="select2 col-lg-9"><?php  $_smarty_tpl->tpl_vars['FOLDER'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FOLDER']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['FOLDERS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['FOLDER']->key => $_smarty_tpl->tpl_vars['FOLDER']->value){
$_smarty_tpl->tpl_vars['FOLDER']->_loop = true;
?><option value="<?php echo $_smarty_tpl->tpl_vars['FOLDER']->value->name();?>
" <?php if ($_smarty_tpl->tpl_vars['FOLDER']->value->name()==$_smarty_tpl->tpl_vars['MAILBOX']->value->trash()){?> selected <?php }?>><?php echo $_smarty_tpl->tpl_vars['FOLDER']->value->name();?>
</option><?php } ?></select><i class="fa fa-info-circle cursorPointer" id="mmSettingInfo" title="<?php echo vtranslate('LBL_CHOOSE_TRASH',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"></i></td><td class="fieldValue selectTrashDesc alert alert-info <?php if ($_smarty_tpl->tpl_vars['MAILBOX']->value->exists()){?>hide<?php }?>"><?php echo vtranslate('LBL_CHOOSE_TRASH_DESC',$_smarty_tpl->tpl_vars['MODULE']->value);?>
