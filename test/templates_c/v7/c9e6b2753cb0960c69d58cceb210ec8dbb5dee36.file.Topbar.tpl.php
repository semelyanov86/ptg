<?php /* Smarty version Smarty-3.1.7, created on 2020-06-04 04:35:53
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Vtiger/partials/Topbar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10337469385ed84ff9d452c8-57525704%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '10337469385ed84ff9d452c8-57525704',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ed84ff9d9b45',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ed84ff9d9b45')) {function content_5ed84ff9d9b45($_smarty_tpl) {?>
...
" aria-hidden="true"></a></div></li><?php }?><li><div><a href="http://salesplatform.ru/wiki/index.php/SalesPlatform_vtiger_crm_7" class="fa fa-info"  title="<?php echo vtranslate('LBL_MANUAL');?>
" aria-hidden="true" target="_blank"></a> </div></li><li class="dropdown"><div style="margin-top: 15px;"><a href="#" class="userName dropdown-toggle" data-toggle="dropdown" role="button"><span class="fa fa-user" aria-hidden="true" title="<?php echo $_smarty_tpl->tpl_vars['USER_MODEL']->value->get('first_name');?>
...
</span></a><div class="dropdown-menu logout-content" role="menu"><div class="row"><div class="col-lg-4 col-sm-4"><div class="profile-img-container" style="background: white !important;"><?php $_smarty_tpl->tpl_vars['IMAGE_DETAILS'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->getImageDetails(), null, 0);?><?php if ($_smarty_tpl->tpl_vars['IMAGE_DETAILS']->value!=''&&$_smarty_tpl->tpl_vars['IMAGE_DETAILS']->value[0]!=''&&$_smarty_tpl->tpl_vars['IMAGE_DETAILS']->value[0]['path']==''){?><i class='vicon-vtigeruser' style="font-size:90px"></i><?php }else{ ?><?php  $_smarty_tpl->tpl_vars['IMAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = false;
