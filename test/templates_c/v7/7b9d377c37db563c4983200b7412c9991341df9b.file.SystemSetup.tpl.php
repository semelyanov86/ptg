<?php /* Smarty version Smarty-3.1.7, created on 2020-06-04 04:35:41
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Users/SystemSetup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:493227265ed84fed79bb87-99115940%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b9d377c37db563c4983200b7412c9991341df9b' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Users/SystemSetup.tpl',
      1 => 1508495595,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '493227265ed84fed79bb87-99115940',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ed84fed7ba9c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ed84fed7ba9c')) {function content_5ed84fed7ba9c($_smarty_tpl) {?>

<html lang="en"><head><title><?php echo vtranslate('Vtiger CRM Setup','Install');?>
</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link REL="SHORTCUT ICON" HREF="layouts/v7/skins/images/favicon.ico"><link rel="stylesheet" href="libraries/bootstrap/css/bootstrap.css" type="text/css" media="screen" /><link rel="stylesheet" href="libraries/bootstrap/css/bootstrap-responsive.css" type="text/css" media="screen"><style type="text/css">
					body{
				...
				</script><div class="container-fluid page-container"><div class="row-fluid"><div class="span6"><div class="logo"><img src="test/logo/vtiger-crm-logo.png" alt="Vtiger Logo"/></div></div><div class="span6"></div></div><div class="row-fluid main-container"><div class="span12 inner-container"><div class="row-fluid"><div class="span8"><h3 style="display: inline-block;float:left;"><?php echo vtranslate('LBL_WHAT_WOULD_YOU_LIKE','Install');?>
</h3></div><div class="span4"><div class="pull-right"><label for="checkbox-1" style="vertical-align:bottom;margin:0;margin-top:8px\9;margin-left:10px\9;font-size:15px;"><strong><?php echo vtranslate('LBL_SELECT_ALL');?>
...
?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==0||$_smarty_tpl->tpl_vars['COUNTER']->value%2==1){?><div class="row-fluid"><?php }?><div class="group-container <?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==0){?> span12 selectedContainer js-basePack <?php }else{ ?> span6 <?php }?>"><div class="module_list"><a><?php echo vtranslate('LBL_VIEW_MODULES','Install');?>
</a></div><div class="row-fluid"><div class="<?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==0){?> span2 <?php }else{ ?> span3 <?php }?>"><img src="layouts/v7/skins/images/<?php echo $_smarty_tpl->tpl_vars['PACKAGE_INFO']->value['imageName'];?>
...
]" value="on"/></div></div><?php }?><div class="reveal_modules"><div><strong><?php echo vtranslate('LBL_ENABLED_FOR_THIS_FEATURE','Install');?>
</strong><hr><div><?php $_smarty_tpl->tpl_vars['ITEMCOUNTER'] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['MODULE_NAME'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['MODULE_NAME']->_loop = false;
...
</p><?php $_smarty_tpl->tpl_vars['ITEMCOUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['ITEMCOUNTER']->value+1, null, 0);?><?php if ($_smarty_tpl->tpl_vars['ITEMCOUNTER']->value==3){?><br><?php $_smarty_tpl->tpl_vars['ITEMCOUNTER'] = new Smarty_variable(0, null, 0);?><?php }?><?php } ?></div></div></div></div><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==0||$_smarty_tpl->tpl_vars['COUNTER']->value%2==1){?></div><?php }?><?php } ?><div class="row-fluid"><div class="span12"></div></div><div class="row-fluid"><div class="span9"><strong><?php echo vtranslate('LBL_NOTE','Install');?>
: </strong><?php echo vtranslate('LBL_NOTE_ABOUT_MODULE_MANAGER','Install');?>
</div><div class="span3"><div class="button-container"><button type="submit" class="btn btn-large btn-primary next" value="Next"><?php echo vtranslate('LBL_NEXT','Install');?>
</button></div></div></div></form></div></div></div></body></html><?php }} ?>