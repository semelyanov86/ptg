<?php /* Smarty version Smarty-3.1.7, created on 2020-06-05 20:12:55
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/CustomerPortal/CustomerPortalDashboard.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3094947835eda7d173b9fd1-75280716%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aad3e80769100a47671036d4e3e4447843522a3d' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/CustomerPortal/CustomerPortalDashboard.tpl',
      1 => 1591234430,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3094947835eda7d173b9fd1-75280716',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5eda7d173db52',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5eda7d173db52')) {function content_5eda7d173db52($_smarty_tpl) {?>
...
" name="widgets[]" <?php if ($_smarty_tpl->tpl_vars['status']->value){?>checked<?php }?>/>&nbsp;&nbsp;<?php echo vtranslate('LBL_ENABLED',$_smarty_tpl->tpl_vars['module']->value);?>
...
" name="widgets[]" <?php if ($_smarty_tpl->tpl_vars['status']->value){?>checked<?php }?>/>&nbsp;&nbsp;<?php echo vtranslate('LBL_ENABLED',$_smarty_tpl->tpl_vars['module']->value);?>
</label></div></div></div><?php }?><?php } ?></div><br>
<?php }} ?>