<?php /* Smarty version Smarty-3.1.7, created on 2020-06-04 12:04:54
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Project/SummaryViewWidgets.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15373520695ed8b936d5c270-55588389%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5b24763f88faa115f08fd255bc28276fe5461f77' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Project/SummaryViewWidgets.tpl',
      1 => 1591234432,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15373520695ed8b936d5c270-55588389',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ed8b936dd288',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ed8b936dd288')) {function content_5ed8b936dd288($_smarty_tpl) {?>
...
" data-validation-engine="validate[<?php if ($_smarty_tpl->tpl_vars['PROGRESS_FIELD_MODEL']->value->isMandatory()==true){?> required,<?php }?>funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" data-fieldinfo='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['FIELD_INFO']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
' <?php if (!empty($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value)){?>data-validator='<?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value);?>
...
" data-validation-engine="validate[<?php if ($_smarty_tpl->tpl_vars['STATUS_FIELD_MODEL']->value->isMandatory()==true){?> required,<?php }?>funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" data-fieldinfo='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['FIELD_INFO']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
' <?php if (!empty($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value)){?>data-validator='<?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value);?>
'<?php }?> ><option value=""><?php echo vtranslate('LBL_SELECT_STATUS',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</option><?php  $_smarty_tpl->tpl_vars['PICKLIST_VALUE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PICKLIST_VALUE']->_loop = false;
 $_smarty_tpl->tpl_vars['PICKLIST_NAME'] = new Smarty_Variable;
