<?php /* Smarty version Smarty-3.1.7, created on 2020-06-11 14:02:42
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/Vtiger/CustomRecordNumbering.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9862074425ee20f5275eef9-76044159%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c420f45620dc246bd2301dfe59d2b17c1ee09839' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/Vtiger/CustomRecordNumbering.tpl',
      1 => 1508495595,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9862074425ee20f5275eef9-76044159',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee20f5277e22',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee20f5277e22')) {function content_5ee20f5277e22($_smarty_tpl) {?>
...
</option><?php } ?></select></div></div></div><div class="row form-group" id="spcompanyRow" <?php if ($_smarty_tpl->tpl_vars['HIDE_SP_COMPANY_ROW']->value){?>style="display: none;"<?php }?>><div class="col-lg-3 col-md-3 col-sm-3 control-label fieldLabel"><label><?php echo vtranslate('LBL_COMPANY',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label></div><div class="fieldValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"><div class=" col-lg-4 col-md-4 col-sm-4"><select class="select2 inputElement " name="spCompany"><?php  $_smarty_tpl->tpl_vars['COMPANY'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['COMPANY']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['SP_PDF_COMPANIES']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['COMPANY']->key => $_smarty_tpl->tpl_vars['COMPANY']->value){
$_smarty_tpl->tpl_vars['COMPANY']->_loop = true;
?><option value="<?php echo $_smarty_tpl->tpl_vars['COMPANY']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['COMPANY']->value=='Default'){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['COMPANY']->value,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
