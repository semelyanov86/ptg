<?php /* Smarty version Smarty-3.1.7, created on 2020-06-06 02:09:54
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:836482645edad0c2b60137-31340673%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7ef7e0bab2b70711627fb663ece7af86aebe1024' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsEdit.tpl',
      1 => 1523977545,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '836482645edad0c2b60137-31340673',
  'function' => 
  array (
  ),
  'variables' => 
...
</label>&nbsp;<select class="select2 lineItemTax" id="taxtype" name="taxtype" style="width: 150px;"><option value="group_tax_inc"<?php if ($_smarty_tpl->tpl_vars['IS_GROUP_TAX_INC_TYPE']->value){?> selected <?php }?>><?php echo vtranslate('LBL_GROUP_TAX_INC',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</option><option value="individual" <?php if ($_smarty_tpl->tpl_vars['IS_INDIVIDUAL_TAX_TYPE']->value){?>selected<?php }?>><?php echo vtranslate('LBL_INDIVIDUAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</option></select></div></div></div><div class="lineitemTableContainer"><table class="table table-bordered lineItemTable" id="lineItemTab"><tr><td><strong><?php echo vtranslate('LBL_TOOLS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
